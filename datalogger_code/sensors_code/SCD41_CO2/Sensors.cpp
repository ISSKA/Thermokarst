/* *******************************************************************************
Sensor code with one SCD41 CO2 sensor on the channel 7 of the multiplexer
**********************************************************************************
...
String names[]={"Vbatt","tempSHT","humSHT","tempBMP","pressBMP","CO2","tempSCD","humSCD"}; //update this list if you add sensors!!!
